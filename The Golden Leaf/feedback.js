...
app.post('/submit-form', async (req, res) => {
  const { fullname,email,phone,age,message,ratings } = req.body;
  ...
  const sql = 'INSERT INTO fed (fullname,email,phone,age,message,ratings) VALUES (?, ?, ?, ?, ?, ?)';
  const values = [fullname,email,phone,age,message,ratings];
